...
**Then** for every drive the **public index** shows, this list shows **at least as much** — the floor being `SAHYOG_DRIVE_ROW_FIELD_IDS` (`apps/public/src/lib/surface-fields.ts:401-428`), **13 field ids**, ⭐ measured against the index **as it stands**, ⛔ not as it stood at authoring
...
**And** the comparison **enumerates all thirteen ids and fails on any the member read omits** — ⛔ never a hand-listed subset, ⭐ which is how [`-188`](../../.decision-log.md#decision-2026-09-04-188) survived
