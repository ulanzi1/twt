...
describe('PERMISSION_CATALOG', () => {
  it('is versioned and seeded with exactly the grounded keys', () => {
    expect(PERMISSION_CATALOG_VERSION).toBe(29); // Story 10.12 bump +2 (pariwar.view_custom_fields/…manage_custom_fields — ONE bump covering both, the 10.8 two-key precedent; 28 at 10.9 banner.manage, 27 at 10.8 +2 feature_flag.view/…flip, 26 at 10.7 member.export_roster, 25 at 10.5 news.manage, 24 at 10.4 helpdesk.respond, 23 at 10.3 helpdesk.create, 22 at 9.8 reconciliation.review, 21 at 7.5 +2 pool.fixed_amount_set/…_emergency, 19 at 6.16, 16 at 6.14, 15 at 6.13, 14 at 6.12, 13 at 6.10, 12 at 6.9, 11 at 6.8, 9 at 6.7, 7 at 6.3, 6 at 5.8, 5 at 5.3, 4 at 4.8, 3 at 4.6, 2 at 2.6, 1 at 1.8)
