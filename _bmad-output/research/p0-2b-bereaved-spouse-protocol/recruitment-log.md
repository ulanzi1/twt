...
|---|---|---|---|
| `pseudonym` | slug | Canonical identity reference | `Bereaved-Spouse-1` (substitute spouse retains same pseudonym; supersession noted) |
