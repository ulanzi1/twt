...
| **Engineer-month** | Single-engineer-month: ~25 focused hours/week at solo cadence (methodology §2 row 1) per PRD §9.1.1 "solo build with A-13 backup", OR ~80 focused hours/week at AI-assisted cadence (methodology §2 row 2 — operational default at 2026-06-04 per D-03-resolved Tasks 7+8 review; 1 AI-cadence month = 346 hr = 80 × 52 / 12 floored). Matches SM-1 ship-target granularity. |
