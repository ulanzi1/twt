...
| **Legal counsel engagement** (per AR-67 — PRD §9.1.1 credential-domain "DPDPA breach-reporting tooling" gated by counsel review) | Story 0.13 | Engagement letter stored at counsel; the escrow inventory references the DPO portal credentials once Story 14.3 authors them |
