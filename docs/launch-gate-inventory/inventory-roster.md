...
- **current_status:** `in-progress` <superseded 2026-06-03 (code review D-01): prior draft had `closed`; reverted to `in-progress` pending ≥2-trustee ratification at Task 9 first monthly review per closure-status-aggregation discipline>
- **closure_evidence_link:** [Decision 2026-05-30-006](../../.decision-log.md#decision-2026-05-30-006) (Story 0.6 author-commit framework + contract template + scope-of-work + escrow envelope; Tasks 7-11 substantive engagement + signature pending; Story 0.6 sprint-status = `done` per closure-status-aggregation discipline at framework-author-commit level)
- **missed_target_escalation_log:** (empty)
- **cross_story_discharge_path:** Story 0.6 Decision 2026-05-30-006 + Story 0.6 Task 11 closure (named engineer + signed contract).
- **notes:** Row set to `in-progress` at Story 0.15 author-commit: framework-leg discharge via Decision 2026-05-30-006 is substantive, but ≥2-trustee ratification under this inventory's governance framework has not yet occurred. Flips to `closed` at Task 9 first monthly review when ≥2 trustees ratify per closure-criteria-rubric.md §5. If a substantive Story 0.6 Tasks 7-11 retraction occurs (e.g., backup-engineer-candidate withdraws), this row supersedes back to `open` per `escalation-protocol.md` §1 trigger 4 (cross-Story discharge-path Story status retreat).
...
- **target_date:** `<TO-BE-AUTHORED-AT-TASK-8>`
- **current_status:** `in-progress` <superseded 2026-06-03 (code review D-01): prior draft had `closed`; reverted to `in-progress` pending ≥2-trustee ratification at Task 9 first monthly review per closure-status-aggregation discipline>
- **closure_evidence_link:** [Decision 2026-06-01-012](../../.decision-log.md#decision-2026-06-01-012) + [Decision 2026-06-01-012-amend-1](../../.decision-log.md#decision-2026-06-01-012-amend-1) (Story 0.12 author-commit + amendment per code review)
- **missed_target_escalation_log:** (empty)
- **cross_story_discharge_path:** Story 0.12 Decision 2026-06-01-012 + Decision 2026-06-01-012-amend-1 + Story 0.12 Task 9 + Task 11 closure.
- **notes:** Row set to `in-progress` at Story 0.15 author-commit: framework-leg discharge via Decisions 012 + 012-amend-1 is substantive, but ≥2-trustee ratification under this inventory's governance framework has not yet occurred. Flips to `closed` at Task 9 first monthly review when ≥2 trustees ratify per closure-criteria-rubric.md §5. Substantive engineer-month estimate authoring + Trustee Panel ≥2-trustee ratification + Epic List + sprint-plan substantive update + Step 4 validation remain pending external action per Story 0.12 deferred-work entries. If Trustee Panel substantively rejects the reconciliation outcome at a later monthly review, this row supersedes back to `open` per `escalation-protocol.md` §1 trigger 4.
