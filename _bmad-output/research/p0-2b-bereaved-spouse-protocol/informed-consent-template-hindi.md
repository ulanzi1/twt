# सूचित सहमति फॉर्म — P0-2b बातचीत (Hindi-primary)

**English glossary:** Informed Consent Form for the P0-2b Bereaved-Spouse Conversation per Story 0.9. Hindi-primary participant-facing form; English mirror at `informed-consent-template-english.md`.

**Researcher (शोधकर्ता):** BigDev (Solo Builder, TWT) — एक software developer; trained ethnographer नहीं, trained grief counselor नहीं.

**Trustee Panel approval (ट्रस्टी पैनल की मंज़ूरी):** यह बातचीत Trustee Panel की मंज़ूरी से हो रही है. Approving trustees: ____________________ (Date: __________). आप किसी भी शिकायत के लिए इन trustees से संपर्क कर सकते हैं: ____________________

---

## (क) यह बातचीत क्यों हो रही है — Participation purpose

"आप इस बातचीत में इस लिए शामिल हो रहे हैं कि बिहार के शिक्षकों के लिए एक welfare trust (TWT) बनाया जा रहा है, और जब किसी शिक्षक के घर में कुछ होता है, परिवार को सहारा देने का तरीका ठीक से बनाया जा सके — इस में आप के जैसा अनुभव रखने वाले लोगों से हमें सीखना ज़रूरी है. आप TWT के सदस्य नहीं बन रहे; आप से कुछ ख़रीदने या किसी तरह की सेवा में जुड़ने की माँग नहीं है. मैं आप के समय का शुक्रिया करता हूँ."
...
## (ग) क्या record किया जाएगा — What is recorded

आप के लिए choice है:
- ☐ **Audio recording** (researcher आप की बातचीत को phone / recorder पर record करेगा; आप कभी भी 'रुक जाइए' कह कर pause कर सकते हैं; recording 30 दिन तक secure storage में रहेगी, फिर destroy की जाएगी)
- ☐ **सिर्फ़ notes** (researcher conversation के दौरान notes लिखेगा; कोई audio नहीं — यह researcher की default preference है)

**आप का choice:** ____________________

---

## (घ) पहचान की सुरक्षा — How identity is protected
...
- **बातचीत से पहले withdraw:** कुछ भी destroy करने की ज़रूरत नहीं — कोई data नहीं रहेगा.
- **बातचीत के दौरान withdraw:** बातचीत तुरंत बंद होगी; notes / recording immediately destroy होंगे.
- **Synthesis से पहले withdraw:** notes / recording destroy होंगे; substitute participant recruit किया जाएगा.
- **Synthesis के बाद withdraw:** आप के contributions synthesis से हटाए जाएँगे; supersession marker noting "Bereaved-Spouse-1 withdrew on <date>".
- **विशिष्ट quote withdraw** (synthesis के बाद भी): वह specific quote हट जाएगा + paraphrase use होगा.

आप को withdraw करने का कोई reason बताने की ज़रूरत नहीं है.
...
- यह reimbursement किसी specific finding पर contingent नहीं है, TWT-join पर contingent नहीं है, referral-ask पर contingent नहीं है.
- आप यह reimbursement मना भी कर सकते हैं — आप की participation acceptance पर कोई असर नहीं.
...
Name signed: _______________________ (substantive नाम — out-of-band storage में रखा जाएगा)
...
**Witness (अगर आप ने witness माँगा हो):**
...
## Withdrawal-contact card (आप के पास रहेगा)
...
(use कीजिए अगर आप कभी भी इस बातचीत के बारे में
follow up करना चाहें)

आप किसी भी समय withdraw कर सकते हैं — पूरी बातचीत
के लिए, या किसी specific quote के लिए. बस trustee को
बता दीजिए — हम तुरंत follow करेंगे.
