...
| `qualification_status` | `engaged` | ⭐⭐ **FULLY VERIFIED 2026-08-24 — all SIX mandatory criteria satisfied** (the last, PI insurance, evidenced the same day `-157` recorded it owed). ⭐ **QUALIFIED** — ⛔ no disqualifying condition obtains (`-157` cl.1). ⚠ Still **de facto** as to lifecycle: the `shortlisted → interviewed → selected` steps were ⛔ never recorded and the Panel ruled Task 7/8 **open for future counsel** (`-157` cl.6, Row 5). ⛔ Do not read this as those steps having occurred |
| `nda_signature_status` | ✅ **`signed` 2026-06-21** · **custody attested, locator WITHHELD BY RULING** | ✅ **`-157` cl.2 DISCHARGED BY DECLINATION 2026-08-28** (`-160` cl.2; sheet A3.1 + Row 7). Executed **off-repo by design**; **§14 step 5 amended the same day** to accept `custody-attested-locator-withheld` as a **complete** state. ✅ **A2.1 box now TICKED** (2026-08-24: unticked, date only). ⛔ No longer OWED; ⛔ do not re-raise |
| `engagement_letter_signature_status` | ✅ **`signed` 2026-06-21** · counsel-side archive = **BANK LOCKER**; **locator WITHHELD BY RULING** | ✅ As above — the counsel-side archive path that `-157` cl.2 recorded owed is **attested 2026-08-28** (sheet A3.1). ⚠⛔ **STILL ⛔ NOT RECORDED, and ⛔ not discharged by this:** §14 also requires **Panel chair + ≥1 further trustee + a trust-side witness**; ⛔ whether those were obtained remains **unrecorded**, and ⛔ counsel was never asked |
| `coi_disclosure_status` | ✅ **`disclosed-no-conflicts`** (fact, attested) · **filing** attested 2026-06-21, locator withheld by ruling | ✅ The **fact** is attested and signed (`-157` cl.1(f)): ⛔ no prior TSCT or mutual-aid-trust engagement. ✅ **A2.3 box now TICKED 2026-08-28** (2026-08-24: unticked, date only); the **filing** falls under the same Row 7 declination. ⛔ Path no longer OWED |
...
| `professional_indemnity` | ✅ **New India Assurance · ₹50 lakh · expiry 2027-08-01** | ⚠ **RESOLVED the same day it was raised — the trail is kept because it is the reason this row exists.** The particulars first given (*LIC · 1 crore · expiry 2045*) describe a **LIFE** policy — LIC of India is a statutory life insurer and ⛔ cannot write PI/E&O; a 2045 expiry is a life-policy maturity where PI cover is annually renewable. ⚠ Counsel confirmed the row was **misread** and a **separate PI policy exists**; particulars followed. ⭐ **PARTICULARS SUPPLIED 2026-08-24 ⇒ `-157` cl.1(e) DISCHARGED and the criterion is EVIDENCED.** New India Assurance **does** write PI/E&O, and a 2027-08-01 expiry fits the **annually renewable** claims-made form. ⚠ Recorded, ⛔ not passed over: the cover figure moved **1 crore → 50 lakh** with the correction (the 1 crore was the life policy); and ⛔ **§12 sets NO numeric floor** — *"adequate … per Counsel's standard coverage"* — so ₹50 lakh is **attested**, ⛔ **not** *"assessed adequate"*. ⚠ **Renews 2027-08-01** |
| `retainer` | ✅ **₹2,00,000 / year · activated 2026-06-21** | Attested 2026-08-24 (`engagement-letter-template.md` §5) |
| `scope_charter_acceptance` | ✅ **`accepted` 2026-06-21** | Counsel accepted `review-scope-charter.md`. ⚠⛔ **Which sharpens the A3.3 problem:** counsel accepted a charter naming the **T&C as priority-1** and the **DPDPA consent flow as §1(b)** — then cited the T&C as his basis for the 11b clearance **without either artifact ever being submitted to him** |
...
| 2 | **2026-08-24** | ⚠⛔ **NARROWED to `/members`.** Originally recorded as all four public surfaces; the three **Epic 11b** surfaces were **HELD** — counsel's basis (*ToS consent*) ⛔ reaches neither deceased subjects and their non-signatory **families** (11b.1/11b.6) nor third-party **nominees** (11b.3), and `2026-08-23-154` already ruled ToS consent insufficient (two levers). ⇒ counsel to **revisit** (`-157` cl.3) | ⭐ **WRITTEN + counsel-signed 2026-08-24** on the consent sheet (A3.1). ⛔ Was verbal-only until then; ⛔ not on letterhead; ⛔ still **not** a §7 Return-receipt | **Cleared for `/members`** → `-156` cl.1 as narrowed by `-157` cl.3. `/members` exposure authorisation (`-156` cl.2) **stands untouched**. ⭐ **The 11b hold was LIFTED 2026-08-28 — see act #3.** ⛔ This row is ⛔ **not** rewritten: the narrowing **did** hold between the two sittings |
| 4 | **2026-08-28** | ⭐ **THE TWO DISCLOSURE CLAUSES DELIVERED, IN WRITING** — *Public Disclosure of Member Information* + *Public Disclosure of Nominee and Claim Information*. ⇒ `2026-08-28-160` **cl.4(b)** and sheet **A2.1** are **DISCHARGED**: the membership T&C now has the express post-death-publication clause the consent model requires, and the nominee clause covers full name + **complete bank-account information** per cl.10(a) | ⭐ **WRITTEN.** Reproduced **verbatim** (verified byte-for-byte) as clauses **14** and **15** of `handover/TWT-Terms-and-Conditions-DRAFT-v0.2-for-counsel-review.docx`; v0.1 retained unaltered as the record of what was handed over | ⛔⛔ **⛔ NOT the priority-1 REVIEW RETURN, and ⛔ NOT a §7 Return-receipt.** The sixteen original clauses stay **unreviewed** and Annex questions **1–7 unanswered**; `review-artifact-roster.md` Row 1 stays `awaiting-counsel-return`, due **2026-09-07** (⛔ the delivery predates the 2026-08-31 earliest-return date, so the window is unaffected). ⚠ Four **new** questions put back to counsel (Annex 8–11), including an **author amendment to clause 13** made to remove a contradiction with counsel's own clause 14 — ⛔ awaiting his confirmation |
| 3 | **2026-08-28** | ⭐⭐ **HOLD LIFTED — all THREE Epic 11b surfaces CLEARED** (11b.1 · 11b.3 · 11b.6). ⛔⛔ **ON A NEW BASIS, ⛔ NOT the one act #2 gave:** the member's own **versioned T&C acceptance** (carrying an express post-death-publication clause) for the member's own name; the **nominee's own Claim Terms** for nominee information + bank details; the **family's own consent** for family-owned information. ⛔ The *ToS-consent* basis of act #2 **stays rejected** on `-157` cl.3's three objections | ⭐ **Counsel signed Part A** of `trustee-consent-sheet-2026-08-28-11b-consent-model.md` (A1.1–A1.5, A2.1–A2.3, A3.1–A3.3). ⛔ Still **not** on letterhead; ⛔ still **not** a §7 Return-receipt (⛔ no returned artifact) | `2026-08-28-160` cl.7. ⭐ `2026-08-23-154` **C-5 superseded WHOLLY as a MECHANISM** (the per-subject-gate lever falls on all three surfaces) — ⛔ **but ⛔ NOT as a per-data-class BASIS**. ⚠ Counsel also **committed to draft the post-death clause into the T&C return** (due **2026-09-07**) and to **prepare the 90-day physical document** |
...
| ✅ **2026-08-24** | ⭐ **FIRST ARTEFACT SUBMITTED** — `epic-2-tc-draft-v1`, in-person handover; acknowledged same day | `lc-1` | `active` | `active` | ⭐ **The `engaged-not-onboarded → active` trigger genuinely fires here** — the roster had already recorded `active` on the strength of two returns, so the status ⛔ does not move, but the event the lifecycle names has now actually occurred. ⚠ 50 days past the AC-1 target; obligation **discharged, LATE**. Return due **2026-09-07** |
