      ...
      try {
        ...
        const resolvedContributors = await mapWithConcurrency(
          ...
          async (contributor): Promise<PublicSahyogVivranContributor> => {
            ...
            // ⚠ ANNOTATED 2026-09-19 — BUILT by Story 11b.21 (`#decision-2026-09-19-224`): the member
            // route keeps the row too, and the two routes now SHARE `kyc/name-render.ts` (D4).
